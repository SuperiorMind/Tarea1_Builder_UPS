...
public class Employee {
    ...
    public Employee(String name, int age, String gender, Address adress, List<Phone> phones, List<Contact> contacs, Department department) {
        this.name = name;
        this.age = age;
        this.gender = gender;
        this.adress = adress;
    ...
    public static class EmployeeBuilder implements IBuilder<Employee>{
        ...
        public EmployeeBuilder setDepartment(String departmentName){
